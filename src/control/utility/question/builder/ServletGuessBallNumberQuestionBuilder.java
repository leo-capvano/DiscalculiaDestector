 ...
 * @version 1.0
 */
public class ServletGuessBallNumberQuestionBuilder extends ServletQuestionBuilder {

    private static final String CORRECT_ANSWER_PARAMETER = "number";
    private static final String CHOICE_PREFIX = "choice-";
    
    public ServletGuessBallNumberQuestionBuilder(QuestionSection questionSection) {
    ...
    protected Question buildQuestion(HttpServletRequest request, HttpServletResponse response) {
        ...
        GuessBallNumberQuestion question = new GuessBallNumberQuestion(questionText, super.questionSection, correctAnswer);
